...
export const Card = function(noteData){
     ...
     * When the card is clicked, it opens a modal with the note's
     * details and allows for updating the note
     */
     ...
     * When the delete button is clicked, it opens a confirmation modal for deleting
     * the associated note.
